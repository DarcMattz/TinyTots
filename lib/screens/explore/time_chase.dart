...
class TimeChase extends StatelessWidget {
  const TimeChase({super.key});
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Find the items as fast as you can before the timer runs out!',
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.black,
                              ),
                            ...
                            method: () {
                              Navigator.pushReplacement(
                                ...
                                PageTransition(
                                  type: PageTransitionType.fade,
                                  alignment: Alignment.center,
                                  child: const TimeChaseCameraView(),
                                ),
                              );
                            },
                          ),

...
import 'package:tinytots/screens/explore/camera_views/riddle_hunt_camera_view.dart';

class RiddleHunt extends StatelessWidget {
  const RiddleHunt({super.key});
...
class _AndroidWelcomeState extends State<AndroidWelcome> {
  ...
  void _play() async {
    await audioService.playFromAssets("sounds/explore/riddle_hunt.m4a");
  }
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Solve the clue and find the matching item before time runs out!',
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.black,
                              ),
                            ...
                            const SizedBox(height: 10),
                            Assets.images.explore.riddle.image(
                            ...
                            method: () {
                              Navigator.pushReplacement(
                                ...
                                PageTransition(
                                  type: PageTransitionType.fade,
                                  alignment: Alignment.center,
                                  child: const RiddleHuntCameraView(),
                                ),
                              );
                            },
                          ),
